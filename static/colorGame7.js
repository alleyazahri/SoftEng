...
var drawingAreaX = 108;
var drawingAreaY = 33;
var drawingAreaWidth = 400;
var drawingAreaHeight = 290;
var toolHotspotStartY = 23*1.6;
var toolHotspotHeight = 38*1.6;
var sizeHotspotStartY = 157*1.6;
var sizeHotspotHeight = 36*1.6;
var sizeHotspotWidthObject = new Object();
sizeHotspotWidthObject.huge = 39*1.6;
sizeHotspotWidthObject.large = 25*1.6;
sizeHotspotWidthObject.normal = 18*1.6;
sizeHotspotWidthObject.small = 16*1.6;
...
function prepareCanvas()
{
	...
	crayonBackgroundImage.src = "/static/images/Crayon-background-new.png";
	
	markerBackgroundImage.onload = function() { resourceLoaded(); 
	};
	markerBackgroundImage.src = "/static/images/Marker-background-new.png";
	
	eraserBackgroundImage.onload = function() { resourceLoaded(); 
	};
	eraserBackgroundImage.src = "/static/images/Eraser-background-new.png";
	...
	{
		// Mouse down location
		var mouseX = e.pageX - this.offsetLeft - xoffset;
		var mouseY = e.pageY - this.offsetTop - yoffset;
		...
		if(mouseX < drawingAreaX) // Left of the drawing area
		{
			if(mouseX > mediumStartX)
			{
				...
				}else if(mouseY > mediumStartY + mediumImageHeight && mouseY < mediumStartY + mediumImageHeight * 2 && markerUnlock > 0){
					curColor = colorGreen;
				}else if(mouseY > mediumStartY + mediumImageHeight * 2 && mouseY < mediumStartY + mediumImageHeight * 3 && markerUnlock > 1){
					curColor = colorYellow;
				}else if(mouseY > mediumStartY + mediumImageHeight * 3 && mouseY < mediumStartY + mediumImageHeight * 4 && markerUnlock > 2){
					curColor = colorBrown;
				}else if(mouseY > mediumStartY + mediumImageHeight * 4 && mouseY < mediumStartY + mediumImageHeight * 5 && markerUnlock > 3){
					curColor = colorBlue;
				}else if(mouseY > mediumStartY + mediumImageHeight * 5 && mouseY < mediumStartY + mediumImageHeight * 6 && markerUnlock > 4){
					curColor = colorRed;
				}
			}
		}
	...
	$('#canvas').mousemove(function(e){
		if(paint==true){
			addClick(e.pageX - this.offsetLeft - xoffset, e.pageY - this.offsetTop - yoffset, true); //adjust for offset
			redraw();
		}
	});
...
function redraw()
{
	...
	if(curTool == "crayon")
	{
		...
		context.drawImage(crayonBackgroundImage, 0, -30, canvasWidth, canvasHeight);
		
		// Purple
		locX = (curColor == colorPurple) ? 15 : 47;
		locY = 25;
		...
		// Green
		locX = (curColor == colorGreen) ? 15 : 47;
		locY += 46;
		...
		// Yellow
		locX = (curColor == colorYellow) ? 15 : 47;
		locY += 46;
		...
		// Brown
		locX = (curColor == colorBrown) ? 15 : 47;
		locY += 46;
	...
	else if(curTool == "marker")
	{
		...
		context.drawImage(markerBackgroundImage, 0, -30, canvasWidth, canvasHeight);
	...
	{
		context.drawImage(eraserBackgroundImage, 0, -30, canvasWidth, canvasHeight);
		context.drawImage(eraserImage, 15, 71, mediumImageWidth, mediumImageHeight);	
	}else{
